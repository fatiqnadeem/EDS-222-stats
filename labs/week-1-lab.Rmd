...
# 
# NOTES FOR FATIQ: 
#   - Go through code once again;
#   - Use gt() to format tables and help students to think about that; 
#   - Give resources to play around with RMD pdf templates; 
#   - MAke the descriptions super easy and give more hints. 
```
...
# Discuss how the sampling strategy biases (or doesn’t) the parameters in Step 4 as approximations of population statistics 
